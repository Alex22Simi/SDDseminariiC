...
void afisareNoduriNivel(nodArb* rad, int nivelCurent, int nivelCautat)
{
	if (rad != NULL)
	{
		...
		{
			afisareNoduriNivel(rad->stanga, nivelCurent + 1, nivelCautat);
			afisareNoduriNivel(rad->dreapta, nivelCurent + 1, nivelCautat);
		}
	}
}
//afisare pe toate nivelurile de facut
...
void main()
{
	...
	printf("\n----------------------\n");
	int nivelCautat = 4;
	printf("\nNoduri de pe nivelul %d:\n", nivelCautat);
	afisareNoduriNivel(rad, 1, nivelCautat);
